...
export class HashFormat implements SchemaGenerator {
	public readonly schema: JSONSchema7 = {
		type: "string",
		description:
			"The hash algorithm used to determine if a file is valid. All functions listed must be supported by tools implementing the packwand pack format.",
		...
		"x-taplo": {
			docs: {
				enumValues: [
					"The SHA2-256 hashing standard. Used as the download-cache key format.",
					"The SHA2-512 hashing standard. Used by default for all new files and index entries.",
