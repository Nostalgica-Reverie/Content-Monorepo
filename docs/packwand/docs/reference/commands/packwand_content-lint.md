## packwand content-lint

Lint pack content — namespaces, texture/model refs, pack.mcmeta, function tags, duplicate and case-colliding files

```
packwand content-lint [pack-dir...] [flags]
```

### Options

```
      --all    Lint every datapack and resourcepack in the workspace
  -h, --help   help for content-lint
      --json   Output lint reports as JSON
```
