...
To load completions in your current shell session:
	...
	source <(packwand completion bash)

To load completions for every new session, execute once:

#### Linux:

	packwand completion bash > /etc/bash_completion.d/packwand

#### macOS:

	packwand completion bash > $(brew --prefix)/etc/bash_completion.d/packwand
