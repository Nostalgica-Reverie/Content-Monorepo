...
features:
  - title: Legacy4J
    icon:
      src: /l4j-icon.webp
      height: 48px
    details: The flagship Legacy Console Edition mod, adapting all features to work with modern Minecraft versions
    link: /mods/legacy4j
    linkText: All Pages
  - title: Legacy Skins
    icon:
  ...
  - title: Minimega
    icon:
      src: /mm-icon.webp
      height: 48px
    details: Recreating all the Mini Games from Legacy Console Edition!
    link: /mods/minimega
    linkText: All Pages
  - title: Legacy World Sizes
    icon:
      src: /lws-icon.webp
      height: 48px
  ...
  - title: Moderner Beta
    icon:
      src: /mb.png
      height: 48px
    details: Moderner Beta's documentation is hosted elsewhere. You can find it here!
