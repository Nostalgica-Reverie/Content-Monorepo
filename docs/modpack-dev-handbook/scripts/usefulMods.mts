...
<!-- 
DO NOT EDIT THIS FILE MANUALLY. Mod entries and page information are sourced from:
docs/modpack-dev-handbook/scripts/useful_mods.json
docs/modpack-dev-handbook/scripts/usefulMods.mts

Manual edits to this file will be overwritten on the next script run.
-->
