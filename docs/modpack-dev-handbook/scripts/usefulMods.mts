...
// Pulls from the handbook useful mods data file.
// Not ran on site build, ran manually through VSCode terminal or NodeJS
// bun run generate:usefulmods
...
https://git.nostalgica.net/Lasting-Legacy/Lasting-Legacy-Monorepo/src/branch/main/docs/modpack-dev-handbook/scripts/useful_mods.json
https://git.nostalgica.net/Lasting-Legacy/Lasting-Legacy-Monorepo/src/branch/main/docs/modpack-dev-handbook/scripts/usefulMods.mts
