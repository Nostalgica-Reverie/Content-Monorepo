...
You'll also want a [`.packwizignore`](/wiki/modpack-management/packwand/reference/pack-format/packwizignore) file so that Git metadata isn't included in the pack index — though packwand ignores `.git/**`, `.gitignore`, and `.gitattributes` by default.
