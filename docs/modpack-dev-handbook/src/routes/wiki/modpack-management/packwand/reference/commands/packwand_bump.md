...
Bump the manifest version (--configs also updates in-pack version files)

```
packwand bump <pack-dir> <new-version> [flags]
```

### Options

```
      --configs   Also update in-pack version files and refresh
