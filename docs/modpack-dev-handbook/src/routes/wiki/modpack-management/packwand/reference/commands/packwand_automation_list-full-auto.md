## packwand automation list-full-auto

List pack directories opted into automation.full_auto (JSON on stdout)

```
packwand automation list-full-auto [flags]
```

### Options

```
  -h, --help   help for list-full-auto
```
