## packwand settings acceptable-loaders

Manage your pack's acceptable mod loaders. Takes a comma-separated list, e.g. fabric,forge

```
packwand settings acceptable-loaders [flags]
```

### Options

```
  -a, --add      Add a loader to the list
  -h, --help     help for acceptable-loaders
  -r, --remove   Remove a loader from the list
```
