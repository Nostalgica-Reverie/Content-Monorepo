...
Build content registries — indexes of referenceable IDs backing IDE completion and validation

```
packwand registry <datapack|config|resourcepack|kubejs|all> [dir] [flags]
```
...
```
  -h, --help   help for registry
      --json   Output the registries as JSON
```
