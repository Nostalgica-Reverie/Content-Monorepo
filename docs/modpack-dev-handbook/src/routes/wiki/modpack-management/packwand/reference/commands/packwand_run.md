...
Execute a user-defined script from the [scripts] section of pack.toml

### Synopsis

Run executes a named script defined under [scripts] in pack.toml.
