...
Add a mod to all (or a specific) pack's Modrinth and CurseForge subdirs

```
packwand add <mod-slug> [pack-dir|pack-subdir] [flags]
```
...
```
  -h, --help         help for add
      --no-refresh   Skip packwand refresh after add (batch adds)
```
