## packwand workspace loader-update

Migrate loaders across packs (honors auto_update)

```
packwand workspace loader-update [latest|recommended] [pack-dir] [flags]
```

### Options

```
  -h, --help   help for loader-update
```
