...
#[tauri::command]
pub fn extension_kubejs_scripts(
    id: String,
...
#[tauri::command]
pub fn extension_kubejs_validate(
    id: String,
    state: State<'_, AppState>,
...
#[tauri::command]
pub fn extension_worldgen_assets(
    id: String,
    state: State<'_, AppState>,
...
#[tauri::command]
pub fn extension_language_files(
    id: String,
    state: State<'_, AppState>,
        ...
        packwand_diagnostics::content_lint(&root)
            ...
            .filter(|issue| {
                ...
                (datapack_enabled && (path.contains("/data/") || path.starts_with("data/")))
                    ...
                    || ((datapack_enabled || resourcepack_enabled) && path.ends_with("pack.mcmeta"))
            })
            .collect()
    } else {
        Vec::new()
...
#[tauri::command]
pub fn extension_content_lint(
    id: String,
    state: State<'_, AppState>,
) -> CommandResult<ValidationReport> {
    let workspace = state.workspace()?;
    let root = pack_root(&workspace, &id)?;
    Ok(packwand_diagnostics::content_lint(root))
}

#[tauri::command]
pub fn extension_registries(
    id: String,
    state: State<'_, AppState>,
...
#[tauri::command]
pub fn extension_blockbench_assets(
    id: String,
    state: State<'_, AppState>,
) -> CommandResult<Vec<ExtensionAsset>> {
    let workspace = state.workspace()?;
...
#[tauri::command]
pub fn extension_krita_open(
    id: String,
    path: String,
    state: State<'_, AppState>,
) -> CommandResult<()> {
    open_asset("krita", &id, &path, &["png", "jpg", "jpeg", "kra"], &state)
}

#[tauri::command]
pub fn extension_blockbench_open(
    id: String,
    path: String,
    state: State<'_, AppState>,
) -> CommandResult<()> {
    open_asset("blockbench", &id, &path, &["json", "bbmodel"], &state)
}
