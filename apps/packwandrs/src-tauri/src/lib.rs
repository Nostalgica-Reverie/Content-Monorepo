...
use commands::{
	...
	identity, instances, jobs, minecraft_accounts, mods, packeater, packs, projects, providers,
	settings, shell, social, somnus, themes, workspace,
};
use tauri::Manager;
...
pub fn run() {
	tauri::Builder::default()
		...
		.invoke_handler(tauri::generate_handler![
			...
			minecraft_accounts::minecraft_accounts_list,
			minecraft_accounts::minecraft_account_sign_in,
			minecraft_accounts::minecraft_account_sign_out,
			minecraft_accounts::minecraft_account_select,
			minecraft_accounts::minecraft_account_set_disabled,
			...
			somnus::somnus_run,
			somnus::somnus_list,
			instances::crud::instances_list,
			instances::crud::instances_get,
			instances::art::instances_icon,
			instances::art::instances_image,
			instances::crud::instances_create,
			instances::io::instances_import,
			instances::io::instances_export,
			instances::crud::instances_edit,
			instances::crud::instances_delete,
			instances::run::instances_install,
			instances::content::instances_manual_pending,
			instances::content::instances_manual_provide,
			instances::content::instances_content_list,
			instances::content::instances_content_toggle,
			instances::content::instances_content_remove,
			instances::files::instances_files_list,
			instances::files::instances_file_read,
			instances::files::instances_file_write,
			instances::run::instances_status_list,
			instances::run::instances_launch,
			instances::run::instances_stop,
