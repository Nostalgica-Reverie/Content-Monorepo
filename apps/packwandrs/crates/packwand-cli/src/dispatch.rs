...
pub fn run() -> Result {
	...
	match matches.subcommand() {
		Some(("account", args)) => account(args),
		Some(("friends", args)) => friends(args),
		Some(("share", args)) => share(args),
		Some(("somnus", args)) => somnus(args),
