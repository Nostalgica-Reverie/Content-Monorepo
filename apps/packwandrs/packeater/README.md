...
> [!IMPORTANT]
> This checkout is **Packeater**, a history-preserving PackSquash fork for
> Packwand. It keeps the PackSquash engine and attribution while adding
> aggressive-by-default optimization, lossy controls, `packeater.json` folder
> discovery, and Forgejo-native CI. See [the Packeater guide](docs/Packeater.md)
> for the new workflow. The upstream documentation below remains useful for
> the underlying optimizer and legacy TOML compatibility.
