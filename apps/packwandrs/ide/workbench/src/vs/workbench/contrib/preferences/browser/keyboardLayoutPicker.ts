...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in Packwand IDE in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open Packwand IDE and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
