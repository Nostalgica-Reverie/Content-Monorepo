...
<template>
  <nav class="rail" aria-label="Primary">
    <div class="rail-group">
      <button class="rail-btn" :class="{ active: currentSidebar === 'explorer' }" title="Explorer" aria-label="Explorer" @click="emit('selectSidebar', 'explorer')">
        <AppIcon name="files" :size="21" />
      </button>
      <button class="rail-btn" :class="{ active: currentSidebar === 'source-control' }" title="Source Control" aria-label="Source Control" @click="emit('selectSidebar', 'source-control')">
        <AppIcon name="source-control" :size="21" />
      </button>
      <button class="rail-btn" :class="{ active: currentSidebar === 'extensions' }" title="Extensions" aria-label="Extensions" @click="emit('selectSidebar', 'extensions')">
