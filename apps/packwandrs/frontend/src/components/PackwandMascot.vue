...
const artwork = computed(() => {
  ...
  const message = mood.value === 'sleeping' ? 'mimimi...' : mood.value === 'waving' ? 'let’s build!' : 'oh, hey!'
...
<template>
  <button
    type="button"
    :class="['packwand-mascot', { 'packwand-mascot--compact': compact, 'packwand-mascot--waving': mood === 'waving' }]"
