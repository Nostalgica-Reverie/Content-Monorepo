    ...
    <label class="raw-input-setting">
      ...
      <span>
        ...
        <small>
          ...
          arrangement breaks something, that configuration is not supported — use Reset layout
          below to get back.
        </small>
      </span>
    </label>
...
<style scoped>
.layout-slots { display: flex; flex-direction: column; gap: 0.4rem; margin-top: 0.5rem; }
...
.layout-slot select { min-width: 9rem; }
</style>
