...
export const packeaterPreview = (id: string) => call<PackeaterPreview[]>('packeater_preview', { id })
export const packeaterInitialize = (id: string) => call<PackeaterMarker>('packeater_initialize', { id })
