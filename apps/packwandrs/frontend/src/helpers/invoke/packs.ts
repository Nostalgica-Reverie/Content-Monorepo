...
export const manifestGet = (id: string) =>
	call<Record<string, unknown> | null>('packs_manifest_get', { id })
export const manifestPut = (id: string, manifest: Record<string, unknown>) =>
	call<void>('packs_manifest_put', { id, manifest })
export const changelogGet = (id: string) => call<string>('packs_changelog_get', { id })
export const changelogPut = (id: string, content: string) =>
	call<void>('packs_changelog_put', { id, content })
