...
const packwandDark: PackwandTheme = {
	...
	colors: {
		...
		'accent-2': '#a78bfa',
		'accent-dim': '#6d51c9',
		'accent-soft': '#8a6df026',
		'accent-line': '#8a6df066',
		danger: '#e2687d',
		'danger-bg': '#33202a',
		'danger-line': '#5c3241',
		warning: '#e0b062',
...
export const builtinThemes: PackwandTheme[] = [
	...
	variant(
		...
		'light',
		{
			...
			'accent-2': '#5236b4',
			'accent-dim': '#49309f',
			'accent-soft': '#6549c81f',
			'accent-line': '#6549c866',
			danger: '#ad304a',
			'danger-bg': '#f9e7eb',
			'danger-line': '#d98a9a',
			warning: '#865b10',
		...
		},
		{
			colors: {
				...
				'editor.foreground': '#2d2d35',
				'editorCursor.foreground': '#6549c8',
				'editor.selectionBackground': '#c8baf0',
				'editor.lineHighlightBackground': '#f1f1f6',
				'editorLineNumber.foreground': '#858590',
				'editorLineNumber.activeForeground': '#2d2d35',
			},
			rules: [
				{ token: 'comment', foreground: '#6f6f79', fontStyle: 'italic' },
				{ token: 'string', foreground: '#26724d' },
				{ token: 'number', foreground: '#865b10' },
				{ token: 'keyword', foreground: '#6549c8' },
	...
	variant('builtin.high-contrast-dark', 'Packwand High Contrast Dark', 'high-contrast', {
		...
		'accent-2': '#dfd5ff',
		'accent-dim': '#a88cff',
		'accent-soft': '#c8b5ff33',
		'accent-line': '#c8b5ffaa',
		danger: '#ff8fa3',
		'danger-bg': '#39000c',
		'danger-line': '#ff8fa3',
		warning: '#ffd37a',
	...
	variant(
		'builtin.high-contrast-light',
		'Packwand High Contrast Light',
		'high-contrast',
		{
			rail: '#ffffff',
			side: '#f2f2f2',
			...
			'accent-2': '#2e117e',
			'accent-dim': '#321681',
			'accent-soft': '#3d1c9e22',
			'accent-line': '#3d1c9eaa',
			danger: '#87001b',
			'danger-bg': '#ffe8ed',
			'danger-line': '#87001b',
			warning: '#604000',
		...
		},
		{
			colors: {
				...
				'editorCursor.foreground': '#3d1c9e',
				'editor.selectionBackground': '#c2afff',
	...
	variant(
		...
		'dark',
		{
			...
			'accent-2': '#ff88a4',
			'accent-dim': '#c63f61',
			'accent-soft': '#f05a7e26',
			'accent-line': '#f05a7e66',
			selected: '#3b2731',
			rail: '#171316',
			side: '#21191e',
			bg: '#241c21',
	...
	variant(
		...
		'dark',
		{
			...
			'accent-2': '#ffad6f',
			'accent-dim': '#bd592d',
			'accent-soft': '#ef7f4526',
			'accent-line': '#ef7f4566',
			selected: '#3e2b22',
			rail: '#171310',
			side: '#211a16',
			bg: '#241d19',
	...
	variant(
		...
		'dark',
		{
			...
			'accent-2': '#4ce68e',
			'accent-dim': '#14a04e',
			'accent-soft': '#1bd96a1f',
			'accent-line': '#1bd96a66',
			success: '#1bd96a',
			'success-bg': '#12281c',
		},
		{
			colors: {
				...
				'editor.foreground': '#e4e4ea',
				'editorCursor.foreground': '#1bd96a',
				'editor.selectionBackground': '#14a04e59',
				'editor.lineHighlightBackground': '#1c1f24',
			},
			rules: [
				{ token: 'string', foreground: '#4ce68e' },
				{ token: 'keyword', foreground: '#1bd96a' },
			],
		},
	),
	variant(
		...
		'dark',
		{
			...
			'accent-2': '#ff8b63',
			'accent-dim': '#c44a24',
			'accent-soft': '#f164361f',
			'accent-line': '#f1643666',
			warning: '#f0a53c',
		},
		{
			colors: {
				...
				'editor.foreground': '#e4e4ea',
				'editorCursor.foreground': '#f16436',
				'editor.selectionBackground': '#c44a2459',
				'editor.lineHighlightBackground': '#1c1c21',
			},
			rules: [
				{ token: 'keyword', foreground: '#f16436' },
				{ token: 'number', foreground: '#f0a53c' },
			],
		},
	),
	variant(
		...
		},
		{
			colors: {
				...
				'editor.selectionBackground': '#1f6feb59',
	...
	variant(
		...
		'light',
		{
			...
			'accent-2': '#0550ae',
			'accent-dim': '#0550ae',
			'accent-soft': '#0969da1f',
			'accent-line': '#0969da66',
			danger: '#a40e26',
			'danger-bg': '#ffebe9',
		...
		},
		{
			...
			rules: [
				...
				{ token: 'keyword', foreground: '#a40e26' },
	...
	variant(
		...
		'dark',
		{
			...
			'accent-2': '#fca326',
			'accent-dim': '#c9541a',
			'accent-soft': '#fc6d261f',
			'accent-line': '#fc6d2666',
			warning: '#fca326',
		},
		{
			colors: {
				...
				'editor.foreground': '#e4e4ea',
				'editorCursor.foreground': '#fc6d26',
				'editor.selectionBackground': '#c9541a59',
				'editor.lineHighlightBackground': '#25242b',
			},
			rules: [
				{ token: 'keyword', foreground: '#fc6d26' },
				{ token: 'number', foreground: '#fca326' },
			],
		},
	),
	variant(
		...
		'dark',
		{
			...
			'accent-2': '#ffa066',
			'accent-dim': '#cc5c1c',
			'accent-soft': '#ff7a2f1f',
			'accent-line': '#ff7a2f66',
			warning: '#ffb454',
		},
		{
			colors: {
				...
				'editor.foreground': '#e4e4ea',
				'editorCursor.foreground': '#ff7a2f',
				'editor.selectionBackground': '#cc5c1c59',
				'editor.lineHighlightBackground': '#1b1e22',
			},
			rules: [
				{ token: 'keyword', foreground: '#ff7a2f' },
