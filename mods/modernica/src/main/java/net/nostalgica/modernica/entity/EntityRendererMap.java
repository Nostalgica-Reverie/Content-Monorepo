        ...
        public EntityRenderer<?, ?> load(EntityType<?> key) throws Exception {
            ...
            synchronized(EntityRenderers.class) {
                ...
                try {
                    ...
                    Modernica.LOGGER.info("Loaded entity {}", BuiltInRegistries.ENTITY_TYPE.getKey(key));
                } catch(RuntimeException e) {
                    Modernica.LOGGER.error("Failed to create entity model for " + BuiltInRegistries.ENTITY_TYPE.getKey(key) + ":", e);
