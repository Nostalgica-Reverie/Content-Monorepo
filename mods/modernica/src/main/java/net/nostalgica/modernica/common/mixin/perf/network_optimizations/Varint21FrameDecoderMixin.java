package net.nostalgica.modernica.common.mixin.perf.network_optimizations;

import io.netty.buffer.ByteBuf;
import io.netty.channel.ChannelHandlerContext;
import net.nostalgica.modernica.network.util.QuietDecoderException;
...
import static net.nostalgica.modernica.network.util.WellKnownExceptions.BAD_LENGTH_CACHED;
import static net.nostalgica.modernica.network.util.WellKnownExceptions.VARINT_BIG_CACHED;
