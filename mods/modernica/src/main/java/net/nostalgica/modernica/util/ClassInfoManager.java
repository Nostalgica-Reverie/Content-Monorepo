...
public class ClassInfoManager {
    ...
    public static void clear() {
        if (!ModernicaMixinPlugin.instance.isOptionEnabled("perf.clear_mixin_classinfo.ClassInfoManager") || hasRun)
            return;
        hasRun = true;
        Modernica.resourceReloadExecutor().execute(ClassInfoManager::doClear);
    }
    ...
    private static void doClear() {
        ...
        Modernica.LOGGER.warn("Cleared mixin data structures");
    }
}
