package net.nostalgica.modernica.platform.fabric;
...
public class ModernicaPlatformHooksImpl implements ModernicaPlatformHooks {
    ...
    private static final String verString = FabricLoader.getInstance().getModContainer("modernica")
    ...
    public MinecraftServer getCurrentServer() {
        return ModernicaFabric.theServer.get();
    }
