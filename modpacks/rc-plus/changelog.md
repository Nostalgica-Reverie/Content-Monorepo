# Re-Console Plus 26.04.2
## IMPORTANT NOTES!
- Because of the size and nature of this update, please update or reset your configs through Config Manager. This can be found in `Modifications > Config Manager`.
- Legacy Skins and Minimega (mini games) will not be included until Legacy4J reaches stable. If you would still like to use these, please stay on 26.04.1.
...
### Removed Legacy Skins and Minimega
Because we are using a development Legacy4J build, we cannot include these mods until Legacy4J reaches a stable release.
...
### Added Plasmo Voice
A FOSS alternative to SVC, aligning with our principles

### Added Complex Leaf Culling
...
### Removed Stfu
Since much of the functionality of Stfu used in Simply Legacy has been merged into base Legacy4J, it has been removed.
