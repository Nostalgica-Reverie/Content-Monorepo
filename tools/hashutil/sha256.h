/* SHA-256 (FIPS 180-4), single-header, dependency-free.
...
#ifndef HASHUTIL_SHA256_H
#define HASHUTIL_SHA256_H
...
static void sha256_final(sha256_ctx *ctx, uint8_t hash[32]) {
    ...
    for (int i2 = 0; i2 < 8; ++i2) {
        ctx->data[63 - i2] = (uint8_t)(ctx->bitlen >> (8 * i2));
    }
    sha256_transform(ctx, ctx->data);
